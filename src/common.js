...
/**
 * Escapes special characters for SVG text.
...
const renderNameTitle = (name, color, ccfLevel, title, cardWidth, rightTop, tag) => {
    ...
    name = escapeSvgText(name);
    tag = escapeSvgText(tag);
    ...
    <g transform="translate(0, 0)" font-family="Verdana, Microsoft Yahei" text-rendering="geometricPrecision">
        ...
        <text x="${cardWidth - 220}" y="0" class="title" font-weight="normal" font-size="13px">
            ${rightTop}
        </text>
    </g>`;
}
...
const renderNameTitle2 = (name, color, ccfLevel, title, cardWidth, rightTop, tag) => {
    ...
    <g transform="translate(0, 0)" font-family="Verdana, Microsoft Yahei" text-rendering="geometricPrecision">
        ...
        <text x="${cardWidth - 250}" y="0" class="title" font-weight="normal" font-size="13px">
            ${rightTop}
        </text>
    </g>`;
}
...
const renderAboutText = (userType, followerCount, followingCount, ranking, slogan, darkmode = false) => {
    ...
    let line2 = "";
    slogan = escapeSvgText(slogan);
    if (followingCount == "0" && followerCount == "0") {
        line2 = `<g transform="translate(25,30)"><text x="0" y="15" class="about-text-grey">TA还没有关注任何人，还没有人关注TA</text></g>`
